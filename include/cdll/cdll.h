...
CDLL_Status cdll_get_node_index(const CDLL*, const void*, bool (*matcher)(const void*, const void*, const size_t), long long*);

CDLL_Status cdll_get_node_at_index(const CDLL*, const int, const void**);
